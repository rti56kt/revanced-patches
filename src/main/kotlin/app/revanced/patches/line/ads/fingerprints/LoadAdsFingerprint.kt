...
internal object LoadAdsFingerprint : MethodFingerprint(
    ...
    strings = listOf(
        ...
        "CREATE TABLE IF NOT EXISTS `sent_event` (`rid_uaid` TEXT NOT NULL, `event_name` TEXT NOT NULL, `timestamp` INTEGER NOT NULL DEFAULT CURRENT_TIMESTAMP, `id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)",
        "CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)"
    ),
    accessFlags = AccessFlags.PUBLIC or AccessFlags.FINAL,
    customFingerprint = { methodDef, _ ->
        methodDef.definingClass == "Lcom/linecorp/line/ladsdk/impl/internal/db/LadDatabase_Impl/a;"
    }
)
